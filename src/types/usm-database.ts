/**
 * Supabase database types for USM + Guardian tables.
 * Matches the deployed migration on pvflufqfeaowzextilpl.
 * These extend (not replace) the existing types in database.ts.
 */
...
/**
 * USM + Guardian database schema.
 * Used by the admin client for Guardian-specific operations.
 * The main app's Supabase client uses the existing untyped approach.
 */
export interface USMDatabase {
  public: {
    Tables: {
      usm_entities: {
        Row: {
