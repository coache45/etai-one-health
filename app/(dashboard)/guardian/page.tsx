...
export default async function GuardianDashboardPage() {
  ...
  // Build radar chart current values
  ...
  // Build baseline from patient record (baseline_cognitive_load is the only scalar we have)
  // Use it as a uniform baseline for visualization until per-dimension baselines are established
